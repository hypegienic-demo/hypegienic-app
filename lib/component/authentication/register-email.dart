...
class RegisterEmailPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _RegisterEmailPageState();
}
class _RegisterEmailPageState extends State<RegisterEmailPage> with StoreWatcherMixin<RegisterEmailPage> {
  ...
  register(BuildContext context) {
    if(this.email != null) {
      authenticationStore.updateRegistrationDetail(email:this.email);
      this.navigate(
        context,
