...
import '../../common/input/email-field.dart';
...
class EditEmailPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _EditEmailPageState();
}
class _EditEmailPageState extends State<EditEmailPage> with StoreWatcherMixin<EditEmailPage> {
  ...
  void initState() {
    ...
    authenticationStore = listenToStore(authenticationStoreToken, (store) {
      ...
      setState(() {
        this.email = authenticationStore.profile?.emailAddress;
      });
  ...
  update(BuildContext context) async {
    if(this.email != null) {
      ...
      try {
        await authenticationStore.editUserProfile(email:this.email);
      ...
      setError('Please make sure you keyed in a valid email address');
    }
  }
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: EmailInputField(
                        value: this.email,
                        onChanged: this.setEmail,
                        onSubmitted: (value) => this.update(context),
                        autofocus: true,
