...
class EditNamePage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _EditNamePageState();
}
class _EditNamePageState extends State<EditNamePage> with StoreWatcherMixin<EditNamePage> {
  ...
  void initState() {
    ...
    authenticationStore = listenToStore(authenticationStoreToken, (store) {
      ...
      setState(() {
        this.name = authenticationStore.profile?.displayName;
      });
  ...
  update(BuildContext context) async {
    if(this.name != null) {
      ...
      try {
        await authenticationStore.editUserProfile(displayName:this.name);
