...
class ConfirmDepositPage extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _ConfirmDepositPageState();
}
class _ConfirmDepositPageState extends State<ConfirmDepositPage> with StoreWatcherMixin<ConfirmDepositPage> {
  ...
  confirm(BuildContext context) async {
    ...
    lockerStore.placeOrder(widget.lockerId, widget.serviceIds, widget.assignedName)
      .then((lockerUnit) => 
  ...
  Widget build(BuildContext context) {
    ...
    final getServiceTypePoint = (Service service) =>
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "You'll need to have sufficient amount in your wallet to retrieve your order",
